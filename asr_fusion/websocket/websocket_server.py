...
from asr_fusion.backend.vad import VoiceActivityDetector
from asr_fusion.backend.base import ServeClientBase
    ...
    def initialize_client(
        ...
        try:
            if self.backend.is_faster_whisper():
                from asr_fusion.backend.faster_whisper_backend import ServeClientFasterWhisper
